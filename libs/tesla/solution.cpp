...
std::map<variable_name, unsigned int, variable_name_comparator> solution::get_solved() const {
	return _solutions;
}
...
bool variable_name_comparator::operator()(const tesla::variable_name &a, const tesla::variable_name &b) const {
	return a.str() < b.str();
}